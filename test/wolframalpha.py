...
def mma(tex):
    ...
    return s.stdout.read().decode("gbk")
def getmma(text):
    import re
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.setStyleSheet(open("..\\bin\\style\\style.qss").read())
...
if __name__ == "__main__":
    ...
    browser = MainWindow()
    browser.show()
    browser.webview.load(QUrl("https://www.wolframalpha.com/input?i2d=true&i=" + a[0]))
    # 运行应用，并监听事件
    sys.exit(app.exec_())